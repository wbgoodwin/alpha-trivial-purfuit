...
export const categories = async () => {
  ...
  return [new Category(categories[0].id, categories[0].color, categories[0].name),
          new Category(categories[1].id, categories[1].color, categories[1].name),
          new Category(categories[2].id, categories[2].color, categories[2].name),
          new Category(categories[3].id, categories[3].color, categories[3].name)]
}
